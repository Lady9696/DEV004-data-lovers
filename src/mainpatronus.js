...
function dibujarPatronus(personajes1) {
  if (!container1) {//de la linea 5 a la 7 lo hacemos para que no nos salga un error de lectura en la consola
    return;
  }
...
if (boton) {
  ...
  boton.addEventListener("click", () => {
    const buscar = document.getElementById("buscar").value;//evento dinamico para obtener el valor del input del usuario
    //console.log(buscar);
