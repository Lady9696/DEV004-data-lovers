...
import { sortCharactersAscendente, filtarCasas, filtarPowerFemale, buscadorPersonajes, obtenerTextoDinamico } from "./data.js";
...
selectores.addEventListener("change", () => { //llamamos al change para lea cuando el usurio cambia de opcion en el selector del dom
