import { sortCharactersAscendente, filtarCasas, filtarPowerFemale, buscadorPersonajes,filtroPatronus, buscadorPatronus } from '../src/data.js';

//import {  } from '../src/data2.js';
...
describe('sortCharactersAscendente', () => {
  ...
  it('returns `sortCharactersAscendente`', () => {
    expect(sortCharactersAscendente(data1, "Alastor Moody")).toStrictEqual(result1);
  });
  test('sin argumento', () => {
